...
import 'currency_amount_row.dart';
...
class _TotalAssetCardState extends State<TotalAssetCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final dailyColor = dailyPositive
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // 총자산 KRW + USD
          CurrencyAmountRow(
            primary: formatKRW(widget.totalValueKRW),
            secondary: formatUSD(widget.totalValueUSD),
            spacing: 12,
          ...
          // 오늘 변동 (항상 표시)
          _buildChangeLabel(
            widget.dailyChangeKRW,
            widget.dailyChangePct,
            dailyColor,
            dailyPositive,
            '오늘',
          ),
          ...
          if (_expanded) ...[
            ...
            Row(
              ...
              children: [
                // 좌: 수익금 + 수익률
                Expanded(
                  child: _buildChangeLabel(
                    widget.totalProfitKRW,
                    widget.totalProfitPct,
                    profitColor,
                    profitPositive,
                    '원금',
                  ),
